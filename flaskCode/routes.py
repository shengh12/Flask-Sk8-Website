...
from flaskCode.forms import RegistrationForm, LoginForm, UpdateAccountForm
from flaskCode.models import User, Post
...
def account():
    ...
    if form.validate_on_submit():
        if form.picture.data:
            picture_file = save_picture(form_picture=form.picture.data, user = current_user)
